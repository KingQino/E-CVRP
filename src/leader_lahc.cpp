...
bool LeaderLahc::greedy_accept(const double &change, [[maybe_unused]] const double &temperature) {
...
LeaderLahc::LeaderLahc(std::mt19937& engine, Case *instance, Preprocessor *preprocessor)
    ...
    perturb_move_dist = uniform_int_distribution(0, 17);
}
...
void LeaderLahc::fully_greedy_local_optimum(Individual *ind) {
    load_individual(ind);
...
bool LeaderLahc::perform_intra_move_greedy(const IntraImproFunc& move_func) const {
    if (num_routes < 1) return false;
...
bool LeaderLahc::perform_inter_move_greedy(const InterImproFunc& move_func) {
    if (num_routes <= 1) return false;
...
bool LeaderLahc::move1_intra_impro(int* route, const int length, const AcceptanceFunc& accept_func, const double temperature) {
    if (length <= 4) return false;
...
bool LeaderLahc::move1_inter_impro(int* route1, int* route2, int& length1, int& length2, int& loading1, int& loading2,
...
bool LeaderLahc::move2_intra_impro(int *route, const int length, const AcceptanceFunc& accept_func,
...
bool LeaderLahc::move2_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2,
    const AcceptanceFunc& accept_func, const double temperature) {
...
bool LeaderLahc::move3_intra_impro(int *route, const int length, const AcceptanceFunc& accept_func,
    const double temperature) {
    if (length <= 4) return false;
...
bool LeaderLahc::move3_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2,
    const AcceptanceFunc& accept_func, const double temperature) {
    if (length1 < 4 || length2 < 3) return false;
...
bool LeaderLahc::move4_intra_impro(int* route, const int length, const AcceptanceFunc& accept_func,
    const double temperature) {
    if (length < 5) return false;
...
bool LeaderLahc::move4_inter_impro(int *route1, int *route2, const int length1, const int length2, int &loading1,
...
bool LeaderLahc::move5_intra_impro(int *route, const int length, const AcceptanceFunc& accept_func,
    const double temperature) {
    if (length < 5) return false;
...
bool LeaderLahc::move5_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2,
    const AcceptanceFunc& accept_func, const double temperature) {
...
bool LeaderLahc::move6_intra_impro(int *route, const int length, const AcceptanceFunc& accept_func,
    const double temperature) {
    if (length < 6) return false;
...
bool LeaderLahc::move6_inter_impro(int *route1, int *route2, const int length1, const int length2, int &loading1,
    int &loading2, const AcceptanceFunc& accept_func, const double temperature) {
...
bool LeaderLahc::move7_intra_impro(int *route, const int length, const AcceptanceFunc& accept_func,
    const double temperature) {
    if (length < 5) return false;
...
bool LeaderLahc::move8_inter_impro(int* route1, int* route2, int& length1, int& length2, int& loading1, int& loading2,
    const AcceptanceFunc& accept_func, const double temperature) {
    if (length1 < 3 || length2 < 3) return false;
...
bool LeaderLahc::move9_inter_impro(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2,
    const AcceptanceFunc& accept_func, const double temperature) {
    if (length1 < 3 || length2 < 3) return false;
...
std::pair<int, int> LeaderLahc::randomly_select_diff_route_pair() const noexcept {
    if (num_routes < 2) {
...
bool LeaderLahc::perturbation(const int strength) {
    bool at_least_one_move = false;

    for (int i = 0; i < strength; ++i) {
        const int choice = perturb_move_dist(random_engine);
        bool move_succeeded = false;
...
bool LeaderLahc::perform_intra_move_pert(const IntraFunc& move_func) const {
    if (num_routes < 1) return false;
...
bool LeaderLahc::perform_inter_move_pert(const InterFunc& move_func) {
    if (num_routes <= 1) return false;
...
bool LeaderLahc::perform_inter_move_with_empty_pert(const InterFunc& move_func) {
    if (num_routes < 1) return false;
...
bool LeaderLahc::move1_intra_pert(int *route, const int length) {
    if (length <= 4) return false;
...
bool LeaderLahc::move1_inter_pert(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 3 || length2 < 3) return false;
    ...
    const int j = dist(random_engine);
...
bool LeaderLahc::move1_inter_with_empty_route_pert(int *route1, int *route2, int &length1, int &length2, int &loading1,
                                                   int &loading2) {
    if (length1 < 4 || length2 != 0) return false; // make sure it won't generate empty route
...
bool LeaderLahc::move2_intra_pert(int *route, const int length) {
    if (length <= 4) return false;
    ...
    const int i = dist1(random_engine);
    int j;
    do {
...
bool LeaderLahc::move2_inter_pert(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 3) return false;
...
bool LeaderLahc::move3_intra_pert(int *route, const int length) {
    if (length <= 4) return false;
...
bool LeaderLahc::move3_inter_pert(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 3) return false;
...
bool LeaderLahc::move4_intra_pert(int *route, const int length) {
    if (length < 5) return false;
    ...
    const int j = distJ(random_engine);
...
bool LeaderLahc::move4_inter_pert(int *route1, int *route2, const int length1, const int length2, int &loading1, int &loading2) {
    if (length1 < 3 || length2 < 3) return false;
...
bool LeaderLahc::move5_intra_pert(int *route, const int length) {
    if (length < 5) return false;
...
bool LeaderLahc::move5_inter_pert(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 4) return false;
...
bool LeaderLahc::move6_intra_pert(int *route, const int length) {
    if (length < 6) return false;
...
bool LeaderLahc::move6_inter_pert(int *route1, int *route2, const int length1, const int length2, int &loading1, int &loading2) {
    if (length1 < 4 || length2 < 4 || (length1 == 4 && length2 == 4)) return false;
...
bool LeaderLahc::move7_intra_pert(int *route, const int length) {
    if (length < 5) return false;
...
bool LeaderLahc::move8_inter_pert(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 3 || length2 < 3) return false;
...
bool LeaderLahc::move8_inter_with_empty_route_pert(int *route1, int *route2, int &length1, int &length2, int &loading1,
    int &loading2) {
...
bool LeaderLahc::move9_inter_pert(int *route1, int *route2, int &length1, int &length2, int &loading1, int &loading2) {
    if (length1 < 3 || length2 < 3) return false;
...
bool LeaderLahc::move9_inter_with_empty_route_pert(int *route1, int *route2, int &length1, int &length2, int &loading1,
    int &loading2) {
